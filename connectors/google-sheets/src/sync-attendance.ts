...
// the removed student-facing cohort concept. Cohorts 1-3 were cut over directly to the
// new live sheets (the old point-in-time sheets are fully retired, no coexistence period),
// and cohort 4 is a new fourth sheet added alongside them.
//
