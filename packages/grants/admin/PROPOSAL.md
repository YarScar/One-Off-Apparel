...
**Deliverable 1 is already built and checked.** It holds 88 questions, 11 categories, 29 approved answers, and 248 recorded funder wordings. The knowledge base is a prototype build. It is sufficient to go forward now, and it will be expanded once the Data team finalises its work.
