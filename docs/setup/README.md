...
| 7 | MCP server — 25 tools | [07-mcp-server.md](07-mcp-server.md) | ✅ Complete | 17 data tools wired to Prisma; the 3 grant tools and 5 skill tools read seed data only; stdio + HTTP + MCP OAuth transports |
