...
| 7 | MCP server — 24 tools | [07-mcp-server.md](07-mcp-server.md) | ✅ Complete | 16 data tools wired to Prisma; the 3 grant tools and 4 skill tools read seed data only; stdio + HTTP + MCP OAuth transports |
