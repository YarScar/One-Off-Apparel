...
| 7 | MCP server — 22 tools | [07-mcp-server.md](07-mcp-server.md) | ✅ Complete | 16 data tools wired to Prisma; the 2 grant tools and 4 skill tools read seed data only; stdio + HTTP + MCP OAuth transports |
